...
static int method_hello(sd_bus_message *m, void *systemdata, sd_bus_error *ret_error) {
    int r;
    char* input;
...
static int method_multiply(sd_bus_message *m, void *systemdata, sd_bus_error *ret_error) {
    int r;
