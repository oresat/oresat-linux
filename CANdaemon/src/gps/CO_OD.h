...
/*3000 */
        #define OD_3000_GPS_Status                                  0x3000

        #define OD_3000_0_GPS_Status_maxSubIndex                    0
        #define OD_3000_1_GPS_Status_currentState                   1

/*3001 */
        #define OD_3001_GPS_Control                                 0x3001

        #define OD_3001_0_GPS_Control_maxSubIndex                   0
        #define OD_3001_1_GPS_Control_newState                      1

/*3002 */
        #define OD_3002_GPS_StateVectorGlobal                       0x3002

        #define OD_3002_0_GPS_StateVectorGlobal_maxSubIndex         0
        #define OD_3002_1_GPS_StateVectorGlobal_positionX           1
        #define OD_3002_2_GPS_StateVectorGlobal_positionY           2
        #define OD_3002_3_GPS_StateVectorGlobal_positionZ           3
        #define OD_3002_4_GPS_StateVectorGlobal_velocityX           4
        #define OD_3002_5_GPS_StateVectorGlobal_velocityY           5
        #define OD_3002_6_GPS_StateVectorGlobal_velocityZ           6
        #define OD_3002_7_GPS_StateVectorGlobal_accelerationX       7
        #define OD_3002_8_GPS_StateVectorGlobal_accelerationY       8
        #define OD_3002_9_GPS_StateVectorGlobal_accelerationZ       9

/*3003 */
        #define OD_3003_GPS_StateVector                             0x3003

        #define OD_3003_0_GPS_StateVector_maxSubIndex               0
        #define OD_3003_1_GPS_StateVector_positionX                 1
        #define OD_3003_2_GPS_StateVector_positionY                 2
        #define OD_3003_3_GPS_StateVector_positionZ                 3
        #define OD_3003_4_GPS_StateVector_velocityX                 4
        #define OD_3003_5_GPS_StateVector_velocityZ                 5
        #define OD_3003_6_GPS_StateVector_velocityY                 6
        #define OD_3003_7_GPS_StateVector_accelerationX             7
        #define OD_3003_8_GPS_StateVector_accelerationY             8
        #define OD_3003_9_GPS_StateVector_accelerationZ             9
...
/*3000      */ OD_GPS_Status_t GPS_Status;
/*3001      */ OD_GPS_Control_t GPS_Control;
/*3002      */ OD_GPS_StateVectorGlobal_t GPS_StateVectorGlobal;
/*3003      */ OD_GPS_StateVector_t GPS_StateVector;
...
/*3000, Data Type: GPS_Status_t */
        #define OD_GPS_Status                                       CO_OD_RAM.GPS_Status

/*3001, Data Type: GPS_Control_t */
        #define OD_GPS_Control                                      CO_OD_RAM.GPS_Control

/*3002, Data Type: GPS_StateVectorGlobal_t */
        #define OD_GPS_StateVectorGlobal                            CO_OD_RAM.GPS_StateVectorGlobal

/*3003, Data Type: GPS_StateVector_t */
