...
/*1601*/ {0x3L, 0x30010110L, 0x30010210L, 0x30010210L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
...
/*1A01*/ {0x3L, 0x30000110L, 0x30000210L, 0x30000310L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
...
/*1010*/ {0x00000003},
/*1011*/ {0x00000001},
/*1201*/ {0x2L, {'T', 'e', 's', 't', 'N', 'a', 'm', 'e', 'P', 'l', 'a', 'c', 'e', 'H', 'o', 'l', 'd', 'e', 'r'}, 0},
/*1202*/ {0x1L, 0x0000L},
/*1203*/ {0x1L, 0x0000L}},
...
/*0x1201*/ const CO_OD_entryRecord_t OD_record1201[3] = {
           {(void*)&CO_OD_RAM.fileTransfer[1].maxSubIndex, 0x06, 0x1 },
           {(void*)&CO_OD_RAM.fileTransfer[1].fileName, 0x0E, 0x13 },
           {(void*)0, 0x0E, 0x0 },
};

/*0x1202*/ const CO_OD_entryRecord_t OD_record1202[2] = {
           {(void*)&CO_OD_RAM.mainProcessControl[2].maxSubIndex, 0x06, 0x1 },
           {(void*)&CO_OD_RAM.mainProcessControl[2].newState, 0x8E, 0x4 },
};

/*0x1203*/ const CO_OD_entryRecord_t OD_record1203[2] = {
           {(void*)&CO_OD_RAM.mainProcessStatus[3].maxSubIndex, 0x06, 0x1 },
           {(void*)&CO_OD_RAM.mainProcessStatus[3].currentState, 0x8E, 0x4 },
};
...
/*0x3000*/ const CO_OD_entryRecord_t OD_record3000[4] = {
           {(void*)&CO_OD_RAM.stateVector.maxSubIndex, 0x06, 0x1 },
           {(void*)&CO_OD_RAM.stateVector.positionX, 0xBE, 0x2 },
           {(void*)&CO_OD_RAM.stateVector.postitionY, 0xBE, 0x2 },
           {(void*)&CO_OD_RAM.stateVector.positionZ, 0xBE, 0x2 },
};

/*0x3001*/ const CO_OD_entryRecord_t OD_record3001[4] = {
           {(void*)&CO_OD_RAM.stateVectorOut.maxSubIndex, 0x06, 0x1 },
           {(void*)&CO_OD_RAM.stateVectorOut.positionX, 0xBE, 0x2 },
           {(void*)&CO_OD_RAM.stateVectorOut.positionY, 0xBE, 0x2 },
           {(void*)&CO_OD_RAM.stateVectorOut.positionZ, 0xBE, 0x2 },
};
...
{0x1201, 0x02, 0x00,  1, (void*)&OD_record1201},
{0x1202, 0x01, 0x00,  1, (void*)&OD_record1202},
{0x1203, 0x01, 0x00,  1, (void*)&OD_record1203},
