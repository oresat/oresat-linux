...
/*1601*/ {0x3L, 0x30000110L, 0x30000210L, 0x30000310L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
...
/*1A01*/ {0x3L, 0x30010110L, 0x30010210L, 0x30010310L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
/*1A02*/ {0x2L, 0x30030510L, 0x30030610L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
...
/*3002*/ {0x6L, {'T', 'h', 'i', 's', 'I', 's', 'A', 'T', 'E', 's', 't', 'F', 'i', 'l', 'e', 'N', 'a', 'm', 'e'}, 0, 0x0000L, 0x0000L, 0x0000L, 0x0},
...
/*0x3000*/ const CO_OD_entryRecord_t OD_record3000[4] = {
           {(void*)&CO_OD_RAM.orientationGlobal.maxSubIndex, 0x06, 0x1 },
           {(void*)&CO_OD_RAM.orientationGlobal.rotationY, 0xBE, 0x2 },
           {(void*)&CO_OD_RAM.orientationGlobal.rotationZ, 0xBE, 0x2 },
           {(void*)&CO_OD_RAM.orientationGlobal.rotationCamera, 0xBE, 0x2 },
};

/*0x3001*/ const CO_OD_entryRecord_t OD_record3001[4] = {
           {(void*)&CO_OD_RAM.orientation.maxSubIndex, 0x06, 0x1 },
           {(void*)&CO_OD_RAM.orientation.rotationY, 0xBE, 0x2 },
           {(void*)&CO_OD_RAM.orientation.rotationZ, 0xBE, 0x2 },
...
/*0x3002*/ const CO_OD_entryRecord_t OD_record3002[7] = {
           ...
           {(void*)&CO_OD_RAM.fileTransfer.fileName, 0x0E, 0x13 },
           {(void*)0, 0x0E, 0x0 },
...
{0x1008, 0x00, 0x06, 19, (void*)&CO_OD_RAM.manufacturerDeviceName},
...
{0x3002, 0x06, 0x00,  1, (void*)&OD_record3002},
